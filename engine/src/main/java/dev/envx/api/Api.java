...
import dev.envx.query.LogService;
...
/**
 * {@code envx api}: the versioned machine interface ({@code docs/api.md}). JSON lines in, one JSON line out per
