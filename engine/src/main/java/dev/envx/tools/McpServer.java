...
public final class McpServer {
    private static final String VERSION = dev.envx.Version.VALUE;
    private static final Gson GSON = new com.google.gson.GsonBuilder().disableHtmlEscaping().create();
    static final String INSTRUCTIONS = """
            envx: local index of this project's Minecraft/Fabric environment (the live server's mods, Minecraft 1.20.1, Yarn names).
