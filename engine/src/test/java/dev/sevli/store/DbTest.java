...
/** Schema upgrades keep old data; an index from a newer sevli is refused instead of misread. */
class DbTest {
    ...
    @Test
    void anIndexFromANewerSevliIsRefused(@TempDir Path home) throws Exception {
        ...
        assertTrue(e.getMessage().contains("newer sevli"), e.getMessage());
